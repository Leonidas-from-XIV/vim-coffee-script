...
function! s:CoffeeCompileUpdate(startline, endline)
  ...
  setlocal modifiable
    ...
    " delete first line (Generated by CoffeeScript…) if it exists
    let outputlines = split(output, "\n")
    if match(outputlines[0], '// Generated by CoffeeScript') == 0
      call remove(outputlines, 0)
      let output = join(outputlines, "\n")
    endif
